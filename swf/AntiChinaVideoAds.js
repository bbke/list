...
AntiChinaVideoAds.prototype = {
    SITES: {
        ...
        'pptv': {
            'player': 'http://www.minggo.cf/swf/pptv.swf',
            're': /http:\/\/player.pplive.cn\/ikan\/.*\/player4player2\.swf/i
        },
		'pplive': {
            'player': 'http://www.minggo.cf/swf/pptvLive.swf',
            're': /http:\/\/player.pplive.cn\/live\/.*\/player4live2\.swf/i
        },
		'sohu': {
           'player': 'http://www.minggo.cf/swf/sohulive.swf',
		...
		'pps': {
            'player': 'http://www.minggo.cf/swf/pps.swf',
            're': /http:\/\/www\.iqiyi\.com\/player\/cupid\/.*\/pps[\w]+.swf/i
        },
		'ppsiqiyi': {
            'player': 'http://www.minggo.cf/swf/iqiyi_out.swf',
